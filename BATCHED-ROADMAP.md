...
After Batch 0, Batches 1 and 2 may run in parallel. Batch 2A has turned the
semantic foundation into paragraph-level, cross-genre reader connections; its
broad default remains gated on the labeled Batch 2 quality review. Batch 3 may also begin
...
- [x] Implement stable paragraph anchors, typed units, graph v2, materialized
  reader indexes, canonical curation, and browser/native parity.
- [x] Exercise the optional Native indicator, grounded card, spoiler reveal,
